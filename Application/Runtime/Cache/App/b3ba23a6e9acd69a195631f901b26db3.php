...
<link href="/wm/Theme/default/Public/css/foods.css" rel="stylesheet"type="text/css">
<script type="text/javascript" src="/wm/Theme/default/Public/js/jquery.min.js"></script>
<script type="text/javascript" src="/wm/Theme/default/Public/js/wemall.js"></script>
<script type="text/javascript" src="/wm/Theme/default/Public/js/alert.js"></script>

<script type="text/javascript">
var appurl = '/wm/index.php';
var rooturl = '/wm';
				...
				<dl>
					...
					<div class="ccbg">
						<?php if(is_array($goods)): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goodsvo): $mod = ($i % 2 );++$i;?><dd menu="<?php echo ($goodsvo["menu_id"]); ?>">
							<div class="tupian">
								<img src="/wm/Public<?php echo ($goodsvo["savepath"]); echo ($goodsvo["image"]); ?>"
		...
		<div id="menu-shadow" hidefocus="true"
			...
			<div class="btn-group"
				...
				<div class="del" style="font-size: 14px;">
					<img src="/wm/Theme/default/Public/images/ajax-loader.gif" alt="loader">正在提交订单...
				</div>
			</div>
		</div>
		...
		<div class="cardexplain">
			<div id="page_tag_load" hidefocus="true"
				...
				<div class="btn-group"
					style="position: fixed; font-size: 12px; width: 220px; bottom: 80px; left: 50%; margin-left: -110px; z-index: 999;">
					<div class="del" style="font-size: 14px;">
						<img src="/wm/Theme/default/Public/images/ajax-loader.gif" alt="loader">正在获取订单...
					</div>
				</div>
			</div>
	...
	<div class="footermenu">
		<ul>
			<li id="home"><a class="active" href="javascript:void(0);"> <img
					src="/wm/Theme/default/Public/images/home.png">
					<p>首页</p>
			</a></li>

			<li id="cart"><a href="javascript:void(0);"> <span class="num" id="cartN2">0</span> <img
					src="/wm/Theme/default/Public/images/cart.png">
					<p>购物车</p>
			</a></li>
			<li id="user"><a href="javascript:void(0);"> <img src="/wm/Theme/default/Public/images/user.png">
					<p>我的</p>
			</a></li>
		</ul>
	</div>
